...
Canonical Lane research workspace for a flagship problem in coarse geometry and operator K-theory:
proving persistence of the coarse assembly package through an admissible coarse-geometric closure architecture.

## Main Manuscript

- [paper/COARSE_BAUM_CONNES_CONJECTURE_PREPRINT.md](paper/COARSE_BAUM_CONNES_CONJECTURE_PREPRINT.md)
- [paper/CANONICAL_ROUTING_INDEX.md](paper/CANONICAL_ROUTING_INDEX.md)

## Structure

- `paper/`
  - `COARSE_BAUM_CONNES_CONJECTURE_PREPRINT.md`
...
1. Theorem chain first: read `paper/COARSE_BAUM_CONNES_CONJECTURE_PREPRINT.md`.
...
Current CBC runner policy:

- `repro/run_repro.sh` extracts, promotes, runs `scripts/cbc_closure_guard.py`, updates `repro/repro_manifest.json`, and enforces `fully_extracted` release-gate mode.
...
3. artifact key consumed by `scripts/cbc_closure_guard.py`.
...
- Manuscript target: [paper/COARSE_BAUM_CONNES_CONJECTURE_PREPRINT.md](paper/COARSE_BAUM_CONNES_CONJECTURE_PREPRINT.md)
