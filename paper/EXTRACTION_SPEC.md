# Constant Extraction Spec (CBC)
    ...
    ## Formula Set
    - `kappa_coarse_raw = c_coarse_raw * coarse_density_raw - e_coarse_raw`
- `sigma_metric_raw = metric_floor_raw - coarse_loss_raw - restart_loss_raw`
- `kappa_compact_raw = 1.0 / (1.0 + delta_comp_sup_raw)`
- `rho_rigidity_raw = rho_rigidity_raw`
- `coarse_transfer_raw = c_transfer_raw * transfer_gain_raw - e_transfer_raw`
- `eps_coh_raw = eps_coh_raw`
- `sigma_star_can_raw = sigma_star_can_raw`

    ## Validations
    - positivity required for: `kappa_coarse`, `sigma_metric`, `kappa_compact`, `rho_rigidity`, `coarse_transfer`, `sigma_star_can`
    ...
    3. `scripts/cbc_closure_guard.py`
