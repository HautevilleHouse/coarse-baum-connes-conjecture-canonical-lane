...
mkdir -p .codex_tmp/coarse_baum_connes_conjecture
cp artifacts/stitch_constants.json .codex_tmp/coarse_baum_connes_conjecture/stitch_constants.json
cp artifacts/constants_registry.json .codex_tmp/coarse_baum_connes_conjecture/constants_registry.json
python3 scripts/cbc_closure_guard.py --strict-coh-zero --registry artifacts/constants_registry.json --stitch artifacts/stitch_constants.json --out repro/certificate_runtime.json --history repro/drift_guard_runs.jsonl --pretty
