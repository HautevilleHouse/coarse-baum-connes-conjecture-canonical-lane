...
mkdir -p .repro_tmp/coarse_baum_connes_conjecture
cp artifacts/stitch_constants.json .repro_tmp/coarse_baum_connes_conjecture/stitch_constants.json
cp artifacts/constants_registry.json .repro_tmp/coarse_baum_connes_conjecture/constants_registry.json
