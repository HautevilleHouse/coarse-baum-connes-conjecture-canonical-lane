...
mkdir -p .tmp/coarse_baum_connes_conjecture
cp artifacts/stitch_constants.json .tmp/coarse_baum_connes_conjecture/stitch_constants.json
cp artifacts/constants_registry.json .tmp/coarse_baum_connes_conjecture/constants_registry.json
